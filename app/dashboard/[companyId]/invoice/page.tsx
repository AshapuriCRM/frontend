...
import { Plus, Eye, FileText, Download, Upload, File, FileSpreadsheet, Image } from 'lucide-react';
...
export default function InvoicePageClient({ params }: InvoicePageClientProps) {
    ...
    <AnimatedPage>
      <div className="space-y-4">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-base">Upload attendance files and generate professional invoices</p>
        </div>
